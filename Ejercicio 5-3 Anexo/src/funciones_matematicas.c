...
void CargarEnterosNoSecuencial (int listaEnteros[], int tam, char mensaje[], char mensajeError[],  int minimo, int maximo){
	...
	if(listaEnteros!=NULL){
		...
		do{
			...
			i=IngresarNumeroEntero(mensaje, mensajeError, minimo, maximo);
...
void MenuEnteros (int listaEnteros[], int tam, char mensaje[], char mensajeError[], int minimo, int maximo){
