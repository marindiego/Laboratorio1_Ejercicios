    ...
    do
	{
							   ...
							   0) )  //Reintentos
    	{
				...
				if (kilometros > 0) {
					   ...
					   )
					{
						if (precioA >= precioL) {
							...
							diferenciaPrecio = precioL - precioA;
						}
			...
			case 5:
				...
				if (
						!HardcodearDatosAgenciasDeVuelo("Latam", KILOMETROS, 1350000.76, DESCUENTO, INTERESES)
						&&
						!HardcodearDatosAgenciasDeVuelo("Aerolíneas", KILOMETROS, 1335000.66,DESCUENTO, INTERESES))
				{
